...
2. Edit the checkout page (more about [WooCommerce checkout block](https://wpdesk.net/sk/checkout-fields-for-blocks-rm-blocks/)).
...
Learn about [Use of Data Policy by WP Desk Plugins](https://wpdesk.net/sk/checkout-fields-for-blocks-data-policy/)
...
👉 [Discover the add-on!](https://wpdesk.net/sk/wp-fcf-for-blocks-conditional-checkout-fields)
...
👉 [Discover the add-on!](https://wpdesk.net/sk/wp-fcf-pricing)
...
Please report security bugs found in the source code of the Checkout Fields for Blocks plugin through the [Patchstack Vulnerability Disclosure Program](https://patchstack.com/database/vdp/0999a353-db21-4b04-b120-f9a407e53674). The Patchstack team will assist you with verification, CVE assignment, and notify the developers of this plugin.
...
= 1.2.0 - 2026-01-21 =
* Added support for Checkout Fields for Blocks - Pricing for Fields plugin
* Added support for WooCommerce 10.5

= 1.1.5 - 2025-12-16 =
* Fixed textarea field do not preserve line breaks
