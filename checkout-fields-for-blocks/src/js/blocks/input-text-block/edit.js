...
export const Edit = ( { attributes, setAttributes, clientId } ) => {
	...
	}, [ clientId, fieldId, parentBlockName, inputType, setAttributes ] );
	...
	return (
		<>
			<InspectorControls>
				...
				{ applyFilters(
					'checkoutFields.conditionalLogicPanel',
					<ConditionalLogicTeaser />,
					'checkout-fields-for-blocks/input-text',
					{ attributes, setAttributes }
				) }

				{ applyFilters(
					'checkoutFields.pricingPanel',
					<PricingTeaser />,
					'checkout-fields-for-blocks/input-text',
					{ attributes, setAttributes }
				) }
