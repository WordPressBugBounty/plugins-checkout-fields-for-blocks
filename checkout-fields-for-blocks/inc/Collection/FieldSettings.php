...
class FieldSettings {
	...
	private const PRICING_SETTINGS    = 'pricingSettings';
	private const PRICING_ENABLED     = 'enabled';
	private const PRICING             = 'pricing';
	private const PRICING_OPTIONS     = 'optionsPricing';
	...
	public function has_pricing(): bool {
		return filter_var( $this->data[ self::PRICING_SETTINGS ][ self::PRICING_ENABLED ] ?? false, FILTER_VALIDATE_BOOLEAN );
	}

	/**
	 * @param string $option_value
	 *
	 * @return array{calculationMethod: string, priceValue: string, taxClass: string}
	 */
	public function get_option_pricing( string $option_value ): array {
		return $this->data[ self::PRICING_SETTINGS ][ self::PRICING_OPTIONS ][ $option_value ] ?? [];
	}
	...
	public function get_pricing(): array {
		return $this->data[ self::PRICING_SETTINGS ][ self::PRICING ] ?? [];
	}
}
