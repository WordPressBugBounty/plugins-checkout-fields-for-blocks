...
namespace CBFieldsVendor\WPDesk\Plugin\Flow;

use CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'checkout-fields-for-blocks';
     ...
     */
    private function init_translations(\CBFieldsVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \CBFieldsVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \CBFieldsVendor\WPDesk_Plugin_Info();
