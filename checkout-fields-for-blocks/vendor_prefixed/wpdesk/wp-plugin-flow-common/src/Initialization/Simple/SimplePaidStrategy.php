...
namespace CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use CBFieldsVendor\WPDesk\Helper\HelperRemover;
use CBFieldsVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use CBFieldsVendor\WPDesk\License\PluginRegistrator;
use CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use CBFieldsVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use CBFieldsVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\CBFieldsVendor\WPDesk_Plugin_Info $plugin_info)
    {
