...
<h2><?php 
\printf(\esc_html__('You are deactivating %s plugin.', 'checkout-fields-for-blocks'), \esc_html($plugin_name));
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\esc_html_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'checkout-fields-for-blocks');
?></strong></h4>
			<ul id="reasons-list">
				<li class="reason">
					<label>
					<span>
						...
						<span><?php 
\esc_html_e('The plugin suddenly stopped working', 'checkout-fields-for-blocks');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('The plugin broke my site', 'checkout-fields-for-blocks');
?></span>
					</label>
				</li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\esc_html_e('I found a better plugin', 'checkout-fields-for-blocks');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\esc_html_e('What\'s the plugin\'s name?', 'checkout-fields-for-blocks');
?>">
					</div>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I only needed the plugin for a short period', 'checkout-fields-for-blocks');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I no longer need the plugin', 'checkout-fields-for-blocks');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'checkout-fields-for-blocks');
?></span>
					</label>
				</li>
				<li class="reason has-input">
					...
					<span>
						...
						<span><?php 
\esc_html_e('Other', 'checkout-fields-for-blocks');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\esc_attr_e('Kindly tell us the reason so we can improve', 'checkout-fields-for-blocks');
?>">
					</div>
				</li>
			</ul>
...
\esc_html_e('Cancel', 'checkout-fields-for-blocks');
?></a>
