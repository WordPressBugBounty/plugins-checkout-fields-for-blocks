...
use CBFieldsVendor\Psr\Log\LoggerInterface;
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\CBFieldsVendor\WPDesk_Tracker::class, 'schedule']);
    ...
    public function send_scheduled_tracking_data()
    {
        ...
        if ($tracker instanceof \CBFieldsVendor\WPDesk_Tracker) {
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \CBFieldsVendor\WPDesk_Tracker_Factory_Prefixed($this->logger);
